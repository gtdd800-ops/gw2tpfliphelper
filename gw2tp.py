...
if df_all.empty:
    ...
    if not df_all.empty:
        ...
        # --- Clés (i18n) côté JS : robustes et sans échappements casse-gueule ---
        keys = {
            "NAME": T("Nom"),
            "PROFIT": T("Profit Net"),
            "ROI": T("ROI (%)"),
        ...
        <style>
          ...
          .gsc-head, .gsc-row {{
            display:grid;
            /* 13 colonnes : Nom, Profit, ROI, Achat, Vente, Qmin, Supply, Demand, Qopt, Popt, ID, ChatCode, Copier */
